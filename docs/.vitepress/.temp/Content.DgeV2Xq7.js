...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"剑网三无界端PVP攻略","description":"剑网三无界端全门派PVP新手攻略","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"门派选择","link":"/"}],"sidebar":{"/cangyun/":[{"text":"苍云","items":[{"text":"首页","link":"/cangyun/"},{"text":"技能详解","link":"/cangyun/skills"},{"text":"流派选择","link":"/cangyun/builds"},{"text":"PVP战术","link":"/cangyun/tactics"},{"text":"配装指南","link":"/cangyun/equipment"}]}]},"footer":{"message":"攻略内容仅供参考，实际游戏内容以官方版本为准","copyright":"剑网三无界端PVP攻略 v2.0"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
